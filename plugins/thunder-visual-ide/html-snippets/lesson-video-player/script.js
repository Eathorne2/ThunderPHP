...
const completeButton = root.querySelector('[data-complete-lesson]');

completeButton?.addEventListener('click', () => {
    const isComplete = completeButton.classList.toggle('is-complete');

    completeButton.textContent = isComplete ? 'Lesson complete' : 'Mark complete';
});
