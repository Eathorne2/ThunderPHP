...
<div class="ta-shell ta-shell--executive" data-ta-shell style="<?= e($admin_palette_style) ?>">
    ...
    <div class="ta-main">
        ...
        <main class="ta-content">
            <div class="ta-executive-context">
                <span class="ta-executive-context__label"><i class="fa-solid fa-briefcase" aria-hidden="true"></i> Executive workspace</span>
                <span class="ta-executive-context__date"><?= e(date('D, d M Y')) ?></span>
            </div>
