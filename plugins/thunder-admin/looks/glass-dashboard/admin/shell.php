...
<div class="ta-shell ta-shell--glass-dashboard" data-ta-shell style="<?= e($admin_palette_style) ?>">
    <div class="ta-glass-backdrop" aria-hidden="true">
        <span class="ta-glass-backdrop__orb ta-glass-backdrop__orb--one"></span>
        <span class="ta-glass-backdrop__orb ta-glass-backdrop__orb--two"></span>
        <span class="ta-glass-backdrop__orb ta-glass-backdrop__orb--three"></span>
        <span class="ta-glass-backdrop__grid"></span>
    </div>
    ...
    <div class="ta-main">
        ...
        <main class="ta-content">
            ...
            <div class="ta-glass-workspace-bar">
                <span class="ta-glass-workspace-bar__label"><i class="fa-solid fa-sparkles" aria-hidden="true"></i> Glass workspace</span>
                <span class="ta-glass-workspace-bar__palette"><?= e($admin_palette['name'] ?? 'Custom palette') ?></span>
            </div>
