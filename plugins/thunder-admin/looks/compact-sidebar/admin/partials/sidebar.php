...
?>
<aside class="ta-sidebar ta-sidebar--compact" data-ta-sidebar>
    <div class="ta-sidebar__brand-row">
        <a class="ta-brand" href="<?= e(admin_url()) ?>" title="<?= e(app_name()) ?>">
            <?php if (app_logo() !== ''): ?>
    ...
    <button class="ta-sidebar__desktop-toggle ta-sidebar__desktop-toggle--compact" type="button" data-ta-sidebar-collapse aria-label="Expand navigation" aria-expanded="false">
    ...
    <div class="ta-sidebar__footer">
        <span class="ta-sidebar__version">Thunder Admin 1.5.0</span>
    </div>
</aside>
