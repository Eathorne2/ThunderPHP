            ...
            <aside class="iw-side">
                <div class="iw-brand">
                    <?php if(!empty($logo_url)): ?>
                        <img src="<?= htmlspecialchars($logo_url) ?>" alt="Current logo" class="iw-brand-logo">
                    <?php else: ?>
                ...
                <div class="iw-note">
                    You can edit these settings later from the admin area if the Thunder Config plugin is installed. It comes with new installations.
                </div>
            </aside>
            ...
            <section class="iw-content">
                ...
                <?php if($step === 1): ?>
                    <header class="iw-head">
                        ...
                        <p>This wizard appears because <code>config.php</code> does not exist. It will collect your database and app details, then create <code>config.php</code> from <code>config-sample.php</code>.</p>
                    </header>
                    ...
                    <div class="iw-grid two">
                        <div class="iw-card">
                            <h3>You will need</h3>
                            <ul class="iw-list">
                                <li>Database name, username, password, host, port, and driver</li>
